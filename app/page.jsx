...
export default function Home() {
  ...
  return (
    <>
      <div className="flex flex-col items-center justify-center bg-transparent h-[100vh] w-full scroll-smooth">
        ...
        <section className="flex flex-col  items-center justify-center w-full h-96">
          ...
          <div className="flex flex-col items-center justify-center m-2 px-4">
          ...
          <div>
            <button
              className="h-11 w-32 bg-gradient-to-r from-blue-500 to-purple-500 border-2 border-white hover:border-2 hover:border-violet-800 hover:from-white hover:to-white hover:text-slate-900 rounded-3xl text-center font-semibold text-slate-50 m-2 ease-out duration-200"
              onClick={handleClick}
            >
              Explore
            </button>
